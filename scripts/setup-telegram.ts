...
async function _getWebhookInfo(token: string) {
...
async function main() {
  ...
  log('Send a message to your bot on Telegram (e.g., /start), then press Enter here.\n');
  ...
  log('If you want to use webhooks, provide your Worker URL.\nOtherwise, skip this step.\n');
